...
public class FrontendAuthEnvironmentTests
{
    ...
    public void GetDevelopmentViteEnvironment_ReturnsContractDefinedLocalDefaults()
    {
        ...
        Assert.Equal(FrontendAuthEnvironment.DevelopmentRedirectUri, environment[FrontendAuthEnvironment.RedirectUriVariableName]);
        Assert.Equal(FrontendAuthEnvironment.DevelopmentRedirectUri, environment[FrontendAuthEnvironment.PostLogoutRedirectUriVariableName]);
